...
<main class="constrain-to-1760">
  ...
  <section class="centered-section">
    <img width="100%" height="100%" srcset="{{ site.baseurl }}/assets/img/Lux-Health-apps-on-all-devices.webp 1000w, {{ site.baseurl }}/assets/img/Lux-Health-apps-on-all-devices-800px.webp 800w, {{ site.baseurl }}/assets/img/Lux-Health-apps-on-all-devices-600px.webp 600w" src="{{ site.baseurl }}/assets/img/Lux-Health-apps-on-all-devices.webp" alt="Lux Health apps were made to run on all devices" class="centered-image" />
  </section>
